(function () { // begin enclosed
  ...
  HappnClient.prototype.__performSystemRequest = function (action, data, options, callback) {
    ...
    console.log('writing system requesr:::', message);
    this.socket.write(message);
  };
  ...
  HappnClient.prototype._remoteOff = function (channel, refCount, callback) {
    ...
    this.__performDataRequest(channel, 'off', null, {'refCount': refCount}, function (e, response) {
  ...
  HappnClient.prototype.disconnect = Promisify(function (options, callback) {
    ...
    console.log('doing system request disc:::');
