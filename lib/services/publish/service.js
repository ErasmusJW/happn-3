...
PubSubService.prototype.stats = function (opts) {
  return {
    listeners_SET: this.__listeners_SET.length,
    listeners_REMOVE: this.__listeners_REMOVE.length,
    listeners_ALL: this.__listeners_ALL.length,
    listeners_ONALL: this.__listeners_ONALL.length,
    listeners_wildcard_ALL: this.__listeners_wildcard_ALL.length,
    listeners_wildcard_SET: this.__listeners_wildcard_SET.length,
    listeners_wildcard_REMOVE: this.__listeners_wildcard_REMOVE.length
  }
};
