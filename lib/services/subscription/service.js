...
SubscriptionService.prototype.processMessage = Promise.promisify(function(message, callback){
  try{
...
SubscriptionService.prototype.__emitInitialValues = function (eventId, channel, sessionId, initialItems, protocol, callback) {
...
SubscriptionService.prototype.__emitPublication = function (publication, channel, opts, sessionId, callback){
...
SubscriptionService.prototype.emitToAudience = function (publication, channel, opts, callback) {
  ...
  async.each(audienceSessions, function(sessionId, emitCallback){
    ...
    _this.__emitPublication(JSON.parse(serialized), channel, {clone:false, noCluster:opts.noCluster}, sessionId, emitCallback);

  }, callback);

};

SubscriptionService.prototype.publish = function (request, payload, publishCallback) {
...
SubscriptionService.prototype.__notifyClient = function (socket, eventKey, data) {
