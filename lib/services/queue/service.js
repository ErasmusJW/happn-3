...
QueueService.prototype.stats = function () {
  ...
  if (this.__inboundQueue != null) this.statsInternal.inbound = {
    ...
    running: this.__inboundQueue.running(),
  ...
  if (this.__outboundQueue != null) this.statsInternal.outbound = {
    ...
    running: this.__outboundQueue.running(),
  ...
  if (this.__systemQueue != null) this.statsInternal.system = {
    ...
    running: this.__systemQueue.running(),
  ...
  if (this.__publicationQueue != null) this.statsInternal.publication = {
    ...
    running: this.__publicationQueue.running(),
    rate: this.__publicationQueue.__count / seconds
  };

  if (this.__inboundQueue != null) this.__inboundQueue.__count = 0;
  if (this.__outboundQueue != null) this.__outboundQueue.__count = 0;
  if (this.__systemQueue != null) this.__systemQueue.__count = 0;
  if (this.__publicationQueue != null) this.__publicationQueue.__count = 0;
...
QueueService.prototype.initialize = Promise.promisify(function (config, callback) {
  ...
  if (this.config.mode !== 'queue') { //no queue or quality of service
...
QueueService.prototype.pushInbound = function (message, callback) {
  ...
  return new Promise((resolve, reject) => {
    this.__inboundQueue.push(message, (e) => {
