...
SessionService.prototype.handleMessage = Promise.promisify(function (message, client) {
  ...
  if (!_this.__sessions[client.sessionId]) {
    console.log('discarding in:::');
    return _this.__discardMessage(message);
  }
  ...
  _this.happn.services.queue.pushInbound({raw:message, session:_this.__sessions[client.sessionId].data, id:_this.__currentMessageId}, function(e, processed){

    if (e)
      return _this.systemErrorHandler(e);
